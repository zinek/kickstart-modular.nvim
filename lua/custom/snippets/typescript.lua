...
table.insert(snippets, ls.parser.parse_snippet('cw', 'console.warn($0)'))

table.insert(snippets, ls.parser.parse_snippet('cl', 'console.log($0)'))

table.insert(snippets, ls.parser.parse_snippet('tcw', 'tap(val => { console.warn($0); }),'))

table.insert(snippets, ls.parser.parse_snippet('for', 'for (let ${1:i} = ${2:0}; $1 < ${3:n}; $1++) {\n\t$0\n}'))

table.insert(snippets, ls.parser.parse_snippet('ford', 'for (let ${1:i} = ${2:n}; $1 >= ${3:0}; $1--) {\n\t$0\n}'))

table.insert(snippets, ls.parser.parse_snippet('p', '{ x: ${1:0}, y: ${2:0} }$0'))

table.insert(snippets, ls.parser.parse_snippet('str', 'JSON.stringify(${1:$TM_SELECTED_TEXT}, null, 2)$0'))
...
table.insert(snippets, ls.parser.parse_snippet('sort', '${1:arr}.sort((a, b) => ${2:a} - ${3:b});$0'))
